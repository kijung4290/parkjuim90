...
const EXPERIENCE_CATALOG_VERSION = 1;
...
const preparePortfolioContent = (content) => {
    ...
    if (hasManagedCatalog && hasCurrentExperiences && hasCurrentStories) return portfolio;
    ...
    return {
        ...
        stories: hasCurrentStories ? portfolio.stories : initialPortfolioData.stories,
    };
};
